...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    subroutine emit_point(R, theta, phi, eta, zeta, omega)
    implicit none
    real*8 :: area
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    subroutine grid_assign(l_phot, coord_phot, k_phot, dk0, dkn, l0, ln, Np, coord, Npath, omega)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do iP = 1, Np
        call emit_point(R, theta, phi, eta, zeta, omega)
        call traj(R, theta, phi, eta, zeta, l_phot, coord_phot, k_phot, dk0, dkn, l0, ln, Npath)    
        coord = [R, theta, phi, eta, zeta]
        if (ln > l0) then
            call grid_assign(l_phot, coord_phot, k_phot, dk0, dkn, l0, ln, iP, coord, Npath, omega)
            N_prop = N_prop + 1
        end if
    end do
    return
